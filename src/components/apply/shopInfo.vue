  ...
  data(){
    return {
      data: [
        ...
        {name:"店铺房产类型",alias:"shopEstateType",value:"",placeHolder:"请选择店铺房产类型",input:false,require:true,empty:"请选择店铺房产类型!",index:0,slots:[{values: ['自有房产有按揭', '自有住房无按揭', '租用','其他']}]},
        {name:"店铺类型",alias:"shopType",value:"",placeHolder:"请选择店铺类型",input:false,require:true,empty:"请选择店铺类型!",index:1,slots:[{values: ['烟酒商店', '超市', '便利店','食杂店']}]},
        {name:"市场类型",alias:"shopMarketType",value:"",placeHolder:"请选择市场类型",input:false,require:true,empty:"请选择市场类型!",index:2,slots:[{values: ['城市', '城镇', '农村']}]},
        {name:"用户类型",alias:"shopUserType",value:"",placeHolder:"请选择用户类型",input:false,require:true,empty:"请选择用户类型!",index:3,slots:[{values: ['零售', '批发']}]},
        {name:"店铺规模",alias:"shopScale",value:"",placeHolder:"请选择店铺规模",input:false,require:true,empty:"请选择店铺规模!",index:4,slots:[{values: ['大规模', '中型规模','小规模']}]},
        {name:"店铺经营年限",alias:"shopRunYear",value:"",placeHolder:"请选择店铺经营年限",input:false,require:true,empty:"请选择店铺经营年限!",index:5,slots:[{values: ['10年以上', '5年-10年（含）','3年-5年（含）','1年-3年（含）','1年（含）以内']}]}, 
        {name:"员工数量",alias:"shopStaffCount",value:"",placeHolder:"请选择员工数量",input:false,require:true,empty:"请选择员工数量!",index:6,slots:[{values: ['1-2人', '3-5人','5-10人','10人以上']}]},
        {name:"店铺面积",alias:"shopArea",value:"",placeHolder:"请选择店铺面积",input:false,require:true,empty:"请选择店铺面积!",index:7,slots:[{values: ['10平米以下', '10平米（含）-50平米','50平米（含）-100平米','100平米（含）以上']}]},
        {name:"烟草登记负责人是否一致",alias:"shopRegisterIs",value:"",placeHolder:"请选择！",input:false,require:true,empty:"请选择烟草登记负责人是否一致!",index:8,slots:[{values: ['是', '否']}]},
        {name:"烟草登记联系方式是否一致",alias:"shopContactIs",value:"",placeHolder:"请选择！",input:false,require:true,empty:"请选择烟草登记联系方式是否一致!",index:9,slots:[{values: ['是', '否']}]},
        ...
        {name:"单次进货额度",alias:"shopEveryAmount",value:"",placeHolder:"请选择单次进货额度",input:false,require:true,empty:"请选择单次进货额度!",index:10,slots:[{values: ['0-20000', '20000-50000','50000-100000','100000以上']}]},
        {name:"进货频次",alias:"shopInFrequency",value:"",placeHolder:"请选择进货频次",input:false,require:true,empty:"请选择进货频次!",index:11,slots:[{values: ['月1次', '月2次','月3次','月4次','月大于4次']}]}
      ],
      queryEnum:{},
      applyInfo:{},
    }
