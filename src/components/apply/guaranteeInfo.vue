...
export default{
  data(){
    return {
      data: [
        {name:"担保方式",value:"",placeHolder:"请选择担保方式",input:false,require:false,empty:"请选择店铺类型!",index:0,slots:[{values: ['个人', '企业']}]},
        ...
        {name:"家庭住址",value:"",placeHolder:"请输入家庭住址",type:"text",input:true,require:false,regex:/^.{1,1000}$/i,empty:"家庭住址不能为空!",err:"家庭住址需要在1000字之内!"},
        ...
        {name:"担保机构地址",value:"北京市西城广安门外大街1号",placeHolder:"请输入担保机构地址",type:"text",input:true,require:false,regex:/^.{1,1000}$/i,empty:"担保机构地址不能为空!",err:"担保机构地址需要在1000字之内!"},
        {name:"担保机构经营范围",value:"",linkUrl:"./guarantee/range"},
        {name:"社会信用代码",value:"1321323432423",placeHolder:"请输入社会信用代码",type:"text",input:true,require:false,regex:/^.{1,1000}$/i,empty:"社会信用代码不能为空!",err:"社会信用代码需要在1000字之内!"},
        {name:"公司成立日期",value:"",placeHolder:"请输入公司成立日期",type:"date",input:true,require:false,regex:/^.{1,100}$/i,empty:"公司成立日期不能为空!",err:"公司成立日期需要在1000字之内!"},
