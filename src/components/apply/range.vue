  ...
  data(){
    return {
      ...
      requestMatch:[
        ...
        {name:"riskAssessment",describe:"项目风险评估",url:window.baseUrl+"rest/addInfoForylpayCapply/addRiskInfoForPcOrH5",data:{value:"",field:"riskProjectEvaluate"},regex:/^.{1,100}$/i,require:false,empty:"项目风险评估不能为空!",error:"项目风险评估需要100字以内!"},
        {name:"riskResult",describe:"可能产生的风险结果",url:window.baseUrl+"rest/addInfoForylpayCapply/addRiskInfoForPcOrH5",data:{value:"",field:"riskMaybeRiskResult"},regex:/^.{1,100}$/i,require:false,empty:"可能产生的风险结果不能为空!",error:"可能产生的风险结果需要100字以内!"},
        {name:"overdue",describe:"逾期情况",url:window.baseUrl+"rest/addInfoForylpayCapply/addRiskInfoForPcOrH5",data:{value:"",field:"riskOverdue"},regex:/^.{1,100}$/i,require:false,empty:"逾期情况不能为空!",error:"逾期情况结果需要100字以内!"},
        {name:"litigationCases",describe:"诉讼情况",url:window.baseUrl+"rest/addInfoForylpayCapply/addRiskInfoForPcOrH5",data:{value:"",field:"riskComplain"},regex:/^.{1,100}$/i,require:false,empty:"诉讼情况不能为空!",error:"诉讼情况结果需要100字以内!"},
        {name:"administrativePenalty",describe:"受行政处罚情况",url:window.baseUrl+"rest/addInfoForylpayCapply/addRiskInfoForPcOrH5",data:{value:"",field:"riskAdministrativePunishment"},regex:/^.{1,100}$/i,require:false,empty:"受行政处罚情况不能为空!",error:"受行政处罚情况结果需要100字以内!"},
        {name:"loanUse",describe:"贷款用途",url:window.baseUrl+"rest/addInfoForylpayCapply/addRiskInfoForPcOrH5",data:{value:"",field:"useFor"},regex:/^.{1,1000}$/i,require:false,empty:"贷款用途不能为空!",error:"贷款用途结果需要1000字以内!"},
        {name:"loanDescribe",describe:"贷款描述",url:window.baseUrl+"rest/addInfoForylpayCapply/addRiskInfoForPcOrH5",data:{value:"",field:"loanDescription"},regex:/^.{1,1000}$/i,require:false,empty:"贷款描述不能为空!",error:"贷款描述需要1000字以内!"},
      ],
      applyInfo:{}
    }
  },
