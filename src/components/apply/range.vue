  ...
  data(){
    return {
      ...
      requestMatch:[
        ...
        {name:"sponsorAddress",describe:"担保机构地址",url:"./rest/addInfoForylpayCapply/addEnsureInfo",data:{value:"",field:"ensureOrganizationAddress"},regex:/^.{1,100}$/i,require:false,empty:"家庭住址不能为空!",error:"家庭住址需要100字以内!"},
        {name:"debtSituation",describe:"负债情况",url:"./rest/addInfoForylpayCapply/addRiskInfoForPcOrH5",data:{value:"",field:"riskDebt"},regex:/^.{1,100}$/i,require:false,empty:"负债情况不能为空!",error:"负债情况需要100字以内!"},
        {name:"repayingSource",describe:"还款来源",url:"./rest/addInfoForylpayCapply/addRiskInfoForPcOrH5",data:{value:"",field:"riskPaySource"},regex:/^.{1,100}$/i,require:false,empty:"还款来源不能为空!",error:"还款来源需要100字以内!"},
        {name:"repaymentGuarantee",describe:"还款保障措施",url:"./rest/addInfoForylpayCapply/addRiskInfoForPcOrH5",data:{value:"",field:"riskPayGuarantee"},regex:/^.{1,100}$/i,require:false,empty:"还款保障措施不能为空!",error:"还款保障措施需要100字以内!"},
        {name:"riskAssessment",describe:"项目风险评估",url:"./rest/addInfoForylpayCapply/addRiskInfoForPcOrH5",data:{value:"",field:"riskProjectEvaluate"},regex:/^.{1,100}$/i,require:false,empty:"项目风险评估不能为空!",error:"项目风险评估需要100字以内!"},
        {name:"riskResult",describe:"可能产生的风险结果",url:"./rest/addInfoForylpayCapply/addRiskInfoForPcOrH5",data:{value:"",field:"riskMaybeRiskResult"},regex:/^.{1,100}$/i,require:false,empty:"可能产生的风险结果不能为空!",error:"可能产生的风险结果需要100字以内!"},
        {name:"overdue",describe:"逾期情况",url:"./rest/addInfoForylpayCapply/addRiskInfoForPcOrH5",data:{value:"",field:"riskOverdue"},regex:/^.{1,100}$/i,require:false,empty:"逾期情况不能为空!",error:"逾期情况结果需要100字以内!"},
        {name:"litigationCases",describe:"诉讼情况",url:"./rest/addInfoForylpayCapply/addRiskInfoForPcOrH5",data:{value:"",field:"riskComplain"},regex:/^.{1,100}$/i,require:false,empty:"诉讼情况不能为空!",error:"诉讼情况结果需要100字以内!"},
        {name:"administrativePenalty",describe:"受行政处罚情况",url:"./rest/addInfoForylpayCapply/addRiskInfoForPcOrH5",data:{value:"",field:"riskAdministrativePunishment"},regex:/^.{1,100}$/i,require:false,empty:"受行政处罚情况不能为空!",error:"受行政处罚情况结果需要100字以内!"},
