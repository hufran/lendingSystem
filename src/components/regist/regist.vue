  ...
  <div class="register">
    ...
    <form action="">
      <label for="" class="icon phone">
        <span class="imageIcon" :style="{'background-image':'url('+imageList[3]+')'}"></span>
      ...
      <label for="" class="icon identifying">
        ...
        <span class="imageIcon" :style="{'background-image':'url('+imageList[5]+')'}"></span>
      </label>

      <label for="" class="icon idcard">
        <input type="text" placeholder="请输入身份证号" v-model="idcard" @blur="idblur"/>
        <span class="imageIcon" :style="{'background-image':'url('+imageList[6]+')'}"></span>
      </label>

      <label for="" class="icon password">
        <input type="password" placeholder="请输入密码" v-model="password" @blur="blur('password')"/>
        <span class="imageIcon" :style="{'background-image':'url('+imageList[4]+')'}"></span>
      </label>
  ...
  export default {
    data () {
      return {
        ...
        send: false,
        imageList: [
          window.baseUrl + 'static/images/logo.png',
          window.baseUrl + 'static/images/icon/checked.png',
          window.baseUrl + 'static/images/icon/unchecked.png',
          window.baseUrl + 'static/images/icon/phone.png',
          window.baseUrl + 'static/images/icon/password.png',
          window.baseUrl + 'static/images/icon/identify.png',
          window.baseUrl + 'static/images/icon/idcard.png',
        ]
      }
    },
    methods: {
...
<style scoped>
  ...
  .phone .imageIcon, .password .imageIcon, .identifying .imageIcon, .idcard .imageIcon {
    content: '  ';
    width: 0.6rem;
    height: 0.6rem;
    position: absolute;
