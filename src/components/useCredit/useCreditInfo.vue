  ...
  data(){
    return {
      ...
      data:[
        ...
        {name:"登录密码",alias:"password",value:"",class:{},placeHolder:"请输入登录密码",type:"password",input:true,require:true,regex:/^[a-zA-Z0-9_]{8,16}$/,empty:"登录密码不能为空!",err:"登录密码需要8-16数字与字母组合!"},
      ],
      queryEnum:{},
      checkStatus:false,
      btnDisabled:false
